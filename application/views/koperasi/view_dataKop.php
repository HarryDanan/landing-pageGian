  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <div class="float-end">
          <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>koperasi_kesehatan/inputdata_kes1/<?php echo $dataKoperasi->nikKoperasi; ?>"><i class="fa fa-plus"></i>Kesehatan 1</a>
          <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>koperasi_kesehatan/inputdata_kes2/<?php echo $dataKoperasi->nikKoperasi; ?>"><i class="fa fa-plus"></i>Kesehatan 2</a>
        </div>
        <div class="card-body">
